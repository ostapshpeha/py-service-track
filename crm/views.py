...
from crm.forms import (
    ...
    VehicleForm,
    VehicleUpdateForm,
    ClientLastNameSearchForm,
    VehicleNumberSearchForm,
)
...
class VehicleListView(LoginRequiredMixin, generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["search_form"] = VehicleNumberSearchForm(self.request.GET or None)
        return context
    ...
    def get_queryset(self):
        ...
        if form.is_valid():
            ...
            if q:
                queryset = queryset.filter(number_registration__icontains=q)
...
class VehicleCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    def get_success_url(self):
        return reverse("crm:vehicle-detail", kwargs={"pk": self.object.pk})
...
class ClientListView(LoginRequiredMixin, generic.ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["search_form"] = ClientLastNameSearchForm(self.request.GET or None)
        return context
